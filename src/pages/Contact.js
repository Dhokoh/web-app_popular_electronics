                                ...
                                <div className="d-flex mb-3 justify-content-center">
                                    ...
                                    <div className='container'>
                                        ...
                                        <label className="form-check-label whatsapp-label" htmlFor='whatsapp'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffffff" className="bi bi-whatsapp" viewBox="0 0 16 16">
                                            ...
                                            <label className="form-check-label whatsapp-label" htmlFor='email'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffffff" className="bi bi-envelope-at" viewBox="0 0 16 16">
